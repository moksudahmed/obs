...
# CONFIG
# ---------------------------------------
CREX_URL = "https://crex.com/scoreboard/10WQ/2BK/3rd-Match/1F9/1N/psz-vs-rwp-3rd-match-pakistan-super-league-2026/live"
...
def generate_continuous_commentary(events, batsmen, runs, wickets, over):
    parts = []

    # Priority events
    if "WICKET" in events:
        parts.append(random.choice(COMMENTARY["WICKET"]))
    ...
    with sync_playwright() as p:
        ...
        while True:
            try:
                ...
                # DETECT EVENTS
                # ---------------------------------------
                events = detect_event(runs, wickets, over, ball, lines[16])
